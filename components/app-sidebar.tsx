...
function getNavigationKey(title: string): string {
  const keyMap: { [key: string]: string } = {
    ...
    "Monitoring Installer": "monitoring",
    "Analytics": "reports",
    ...
    "Alerts & Rules": "alertsEvents",
    "Alerts & Events": "alertsEvents",
    "Alerts": "alerts",
    "Events": "events",
    "Alert Rules": "alertRules",
    "Notifications": "notifications",
    "System Management": "deviceManagement",
    ...
    "Services": "services",
    "Tools": "automation",
    "OID Converter": "oidBrowser",
    "SNMP Walker": "snmpTesting",
    "Config Diff": "configValidator",
